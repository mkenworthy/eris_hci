...
blurring_flexing_motion = 150 * um #300 micron absolute worst case, could be 150 and would be OK as decided by Matthew Kenworthy and David Doelman 12-01-2018
...
print('The physical size of the ERIS entrance pupil = {0} mm'.format(np.round(M1_ERIS/Pivot_point_spiders*nx*pixelsize/mm,decimals = 3)))
...
FitsOut.writeto('VLT_ERIS_pupil_D_tightly_undersized_all_uncertainties.fits', clobber = True)
